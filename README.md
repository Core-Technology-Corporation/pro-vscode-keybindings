...
**⚡ Super** (`F12`, o click derecho → "⚡ Super" — disponible tanto en el editor como en el Explorador, mismas extensiones que "Limpiar consolas") hace todo lo anterior y además:
